...
define(["jquery"], function($) {
  $(function() {
    $('body') // já podemos usar seletores de jquery por exemplo
  })
})
...
const linha1 = percorrerLinha477()
for(let parada of linha1) {
  console.log(parada)
}
...
promise.then((data) => console.log(`Resultado negativo: ${data}`))
